...
{
    public static GSS.Controllers.AccountController Account = new GSS.Controllers.T4MVC_AccountController();
    public static GSS.Controllers.AdminController Admin = new GSS.Controllers.T4MVC_AdminController();
    public static GSS.Controllers.HomeController Home = new GSS.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static class CSS {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string aller_bd_webfont_eot = Url("aller_bd-webfont.eot");
            public static readonly string aller_bd_webfont_svg = Url("aller_bd-webfont.svg");
            public static readonly string aller_bd_webfont_ttf = Url("aller_bd-webfont.ttf");
            public static readonly string aller_bd_webfont_woff = Url("aller_bd-webfont.woff");
            public static readonly string aller_it_webfont_eot = Url("aller_it-webfont.eot");
            public static readonly string aller_it_webfont_svg = Url("aller_it-webfont.svg");
            public static readonly string aller_it_webfont_ttf = Url("aller_it-webfont.ttf");
            public static readonly string aller_it_webfont_woff = Url("aller_it-webfont.woff");
            public static readonly string aller_rg_webfont_eot = Url("aller_rg-webfont.eot");
            public static readonly string aller_rg_webfont_svg = Url("aller_rg-webfont.svg");
            public static readonly string aller_rg_webfont_ttf = Url("aller_rg-webfont.ttf");
            public static readonly string aller_rg_webfont_woff = Url("aller_rg-webfont.woff");
            ...
            public static class font {
                private const string URLPATH = "~/Content/CSS/font";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string webhostinghub_glyphs_eot = Url("webhostinghub-glyphs.eot");
                public static readonly string webhostinghub_glyphs_ttf = Url("webhostinghub-glyphs.ttf");
                public static readonly string webhostinghub_glyphsd41d_eot = Url("webhostinghub-glyphsd41d.eot");
            }
            ...
            public static class Images {
                ...
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string add_button_gif = Url("add-button.gif");
                ...
                public static readonly string college_png = Url("college.png");
                public static readonly string del_gif = Url("del.gif");
                public static readonly string digits__png = Url("digits-.png");
                public static readonly string digits_png = Url("digits.png");
                public static readonly string digits1_png = Url("digits1.png");
                ...
                public static readonly string header_gif = Url("header.gif");
                [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
                public static class icons {
                    private const string URLPATH = "~/Content/CSS/Images/icons";
                    public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                    public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                    public static readonly string icon_social_facebook_png = Url("icon-social-facebook.png");
                    public static readonly string icon_social_pinterest_png = Url("icon-social-pinterest.png");
                    public static readonly string icon_social_twitter_png = Url("icon-social-twitter.png");
                }
                ...
                public static readonly string msg_error_gif = Url("msg-error.gif");
                public static readonly string msg_ok_gif = Url("msg-ok.gif");
                public static readonly string notice_png = Url("notice.png");
                public static readonly string pagging_gif = Url("pagging.gif");
                public static readonly string partner_png = Url("partner.png");
                public static readonly string shadow_png = Url("shadow.png");
                public static readonly string success_png = Url("success.png");
                public static readonly string T_logo_png = Url("T_logo.png");
                public static readonly string tab_gif = Url("tab.gif");
                public static readonly string th_gif = Url("th.gif");
            }
        
            public static readonly string jquery_ui_1_8_22_custom_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery-ui-1.8.22.custom.min.css") ? Url("jquery-ui-1.8.22.custom.min.css") : Url("jquery-ui-1.8.22.custom.css");
            ...
            public static readonly string jquery_toastmessage_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.toastmessage.min.css") ? Url("jquery.toastmessage.min.css") : Url("jquery.toastmessage.css");
            ...
            public static readonly string styleAdmin_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/styleAdmin.min.css") ? Url("styleAdmin.min.css") : Url("styleAdmin.css");
        }
    ...
    public static partial class Bundles
    {
        ...
        public static partial class Content 
        {
            public static partial class CSS 
            {
                ...
                public static class Assets
                {
                    public const string bootstrap_responsive_css = "~/Content/CSS/bootstrap-responsive.css";
                    public const string bootstrap_css = "~/Content/CSS/bootstrap.css";
                    public const string jquery_ui_1_8_22_custom_css = "~/Content/CSS/jquery-ui-1.8.22.custom.css";
                    public const string jquery_ui_css = "~/Content/CSS/jquery-ui.css";
                    public const string jquery_alerts_css = "~/Content/CSS/jquery.alerts.css";
                    public const string jquery_toastmessage_css = "~/Content/CSS/jquery.toastmessage.css";
                    public const string style_css = "~/Content/CSS/style.css";
                    public const string styleAdmin_css = "~/Content/CSS/styleAdmin.css";
                }
            }
